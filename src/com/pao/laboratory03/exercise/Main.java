...
import com.pao.laboratory03.exercise.service.*;
            ...
            try {
                switch (option) {
                    ...
                    case "5":
                        ...
                        if (averages.isEmpty()) {
                            System.out.println("Nu exista note pentru a calcula medii.");
                        } else {
                            averages.forEach((subjct, avg) ->
                                    System.out.printf("%s: %.2f%n", subjct.getFullName(), avg));
                        }
                        break;
